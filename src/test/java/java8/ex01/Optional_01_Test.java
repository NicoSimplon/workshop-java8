...
public class Optional_01_Test {
    ...
    public void test_optional_found() throws Exception {
        ...
        Optional<Person> result = Optional.of(this.find(personList, t -> t.getAge() == 10));
    ...
    public void test_optional_notfound() throws Exception {
        ...
        // TODO invoquer la méthode find(List<T> list, Predicate<T> predicate)
        // TODO age == 400
        Optional<Person> result = Optional.ofNullable(this.find(personList, t -> t.getAge() == 400));
    ...
    public void test_optional_notfound_throw_exception() throws Exception {
        ...
        Optional<Person> result = Optional.ofNullable(this.find(personList, t -> t.getAge() == 10 && t.getFirstname().equals("last_10")));
    ...
    public void test_optional_notfound_with_default_value() throws Exception {
        ...
        Person result = Optional.ofNullable(this.find(personList, t -> t.getAge() == 400)).orElse(defaultValue);
